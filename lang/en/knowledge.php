...
return [
    ...
    'pages' => [
        'search' => [
            ...
            'service_unavailable_toast_description' => 'The vector search service may be offline. Please contact your administrator.',
            'admin_instructions' => 'For administrators',
            'admin_start_service' => 'Start the ETL service with',
            'admin_or_update' => 'Or update',
            'admin_in_env' => 'in .env if running locally',
