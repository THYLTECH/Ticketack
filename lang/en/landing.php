    ...
    */
    ...
    'pages' => [
        ...
        'breakout'=> [
            ...
            'teamDescription' =>'Team of French students from Centrale Lille IG2I.'
        ],
        'achievementsTitle' => "Ticketack's Features",
        'achievementsDescription' => 'Ticketack allows you to centralize and simplify the tracking of all your technical issues. This tool reduces difficult tracking, loss of information and lack of visibility caused by problem reports via emails.',
        'achievements' => [
            '1' => [
