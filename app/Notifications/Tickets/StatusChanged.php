...
// app/Notifications/StatusChanged.php
...
class StatusChanged extends Notification implements shouldQueue
{
    ...
    {
        $this->type = 'ticket_status_changed';
        $this->ticket = $ticket;
    }
    ...
    */
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => __("notifications.database." . $this->type . ".message", ['title' => $this->ticket->title, 'status' => $this->ticket->status->title]),
