...
export default function Edit({ asset } : { asset: Asset }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={__('assets.pages.edit.head_title', undefined, { title: asset.title })} />

            <Heading
                title={__('assets.pages.edit.title', undefined, { title: asset.title })}
                description={__('assets.pages.edit.description', undefined, { title: asset.title })}
                action={
