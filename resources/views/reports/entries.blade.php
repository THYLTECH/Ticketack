...
<head>
    ...
    <style>
        ...
        th { text-align: left; padding: 8px 10px; background-color: #0f172a; color: #ffffff; font-weight: bold; text-transform: uppercase; font-size: 10px; }
        td { padding: 8px 10px; border-bottom: 1px solid #e2e8f0; vertical-align: top; }
        tr:nth-child(even) { background-color: #f8fafc; }

        .section-title { font-size: 14px; font-weight: bold; color: #0f172a; margin-top: 30px; margin-bottom: 10px; border-bottom: 1px solid #cbd5e1; padding-bottom: 5px; }
        .week-header { background-color: #e2e8f0; color: #0f172a; font-weight: bold; padding: 8px; font-size: 11px; margin-top: 15px; }
        ...
        .summary-table th { background-color: #cbd5e1; color: #334155; }
